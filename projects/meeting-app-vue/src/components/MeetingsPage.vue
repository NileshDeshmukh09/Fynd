<template>
  <div>
    <main class="container mt-3 mb-3">
      ...
      <div class="tab">
        <button class="tablinks active" onclick="tabSwitch(event, 'search-filter')">
      ...
      <div id="search-filter" class="tabcontent">
        ...
        <div class="filter-box">
          ...
          <div class="filter-content">
            <p><span id="meet-date" class="text-info">05 August 2000</span> 06:00 - 07:00</p>
          ...
          <div class="filter-content">
            <p><span id="meet-date">09 August 2000</span> 09:00 - 10:30</p>
