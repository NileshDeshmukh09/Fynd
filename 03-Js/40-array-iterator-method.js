/**
 * filter() - find all items that satisfy some conditions
 *   filter()- returns and array of items
 */

/**
 * find() - find starting first item that satisfy given condition 
 * find() - return single items
 */

/**
 * forEach() - Iterate through all items and do something
 * forEach() - like a for loop
 *    
 *      DIS-ADVANTAGE 
 *      
 *      ** we cannot use forEach for Descending order 
 */

/**
 * a "transformed " array - ['John' , 'Jane' , 'Mark', 'Marry']
 * map() - original array does not changed
 * map() - returns a new array
 * 
 * if you want to store the list of items in new array , we use  "map()" , because map , can makes a new array in a 
 */

/**
 *  reduce() - an "aggregate" value - min , max , average , sum etc ( single value for the array)
 */
